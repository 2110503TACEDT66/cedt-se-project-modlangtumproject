    ...
    <main className="flex flex-col items-center bg-white px-5">
      ...
      <form className="mt-10 flex w-[60vh] flex-col" onSubmit={handleSubmit}>
        <div>
          <label className="text-m mb-2 block font-semibold text-gray-900">
            ...
            <input
              ...
              id="email"
              name="email"
              className="text-m mt-1 block h-[3em] w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 font-normal text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
        ...
        <div className="mt-3 flex items-start">
          <button
            type="submit"
            className="text-m h-[3em] w-full rounded-lg bg-blue-200 px-5 py-2.5 text-center font-medium text-white hover:bg-blue1"
          >
            Continue
          </button>
        </div>
